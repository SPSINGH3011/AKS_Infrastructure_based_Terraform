...
application_gateways = {
  appgw1 = {
    ...
    virtual_network_name = "dev-aks-vnet"
    public_ip_name       = "dev-aks-pip"
    frontend_ports = {
      port1 = {
        name = "frontendPort1"
        port = 80
...
kubernetes_clusters = {
  aks1 = {
    ingress_application_gateway_name = "dev-aks-appgw"
    resource_group_name              = "dev-aks-rg"
    container_registry_name          = "dev-aksacr007"
...
mssql_databases = {
  mysqldb1 = {
    name                = "dev-aksmssqldb007"
    resource_group_name = "dev-aks-rg"
    server_name         = "dev-aksmssqlserver007"
